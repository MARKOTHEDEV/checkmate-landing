...
const testimonials = [
  {
    ...
    image:
      "https://www.figma.com/api/mcp/asset/5ba3af18-ded7-4587-a337-d925f48a1447",
  ...
  },
  {
    ...
    location: "Lagos, Nigeria",
    image:
      "https://www.figma.com/api/mcp/asset/d0fa8e89-49a0-4f1f-8d99-40209fa54af7",
  ...
  },
  {
    ...
    location: "Lagos, Nigeria",
    image:
      "https://www.figma.com/api/mcp/asset/bbc5d9df-d905-41ec-a5dc-f028cd7e5358",
            ...
            >
              <div className="flex flex-col items-center gap-[12px]">
                ...
                <div className="flex flex-col items-center gap-[8px] text-center">
                  <p className="font-bold text-[#080808] text-[16px]">
                    {testimonials[current].name}
                  </p>
                  <p className="text-[#6d6d6d] text-[14px] font-normal">
                ...
                <div className="flex flex-col items-center gap-[24px] w-full">
                  <div className="flex flex-col items-center gap-[12px]">
                    ...
                    <div className="flex flex-col items-center gap-[4px] text-center">
                      <p className="font-bold text-[#080808] text-[16px] leading-normal">
                        {name}
                      </p>
                      <p className="text-[#6d6d6d] text-[12px] font-normal leading-[20px]">
                        {location}
                      </p>
                    </div>
                  </div>
